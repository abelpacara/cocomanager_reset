...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'COCO Manager';
$config['webmaster_email'] = 'webmaster@cocomanager.com';
...
$config['autologin_cookie_life'] = 60*60*24*15;
...
$config['forgot_password_expire'] = 60*60*24*31*2;
