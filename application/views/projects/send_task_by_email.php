                              ...
                              <tbody><tr>
                                    ...
                                    <td style="padding-left:15px;font-size:14px;font-family:Helvetica,Arial,sans-serif" valign="top">
                                       <div class="im">
                                          <h1 style="line-height:1.3em;font-size:14px;margin:0 0 15px 0;font-family:Helvetica,Arial,sans-serif;font-weight:normal">
                                             ...
                                             if(isset($task['owner_name']))
                                             {
                                                $owner_show_name = $task['owner_name']." ".$task['owner_last_name'];                     
                                             }
                                             else
                                             {
                                                $owner_show_name = $task['owner_email'];
                                             }
                                             $url_profile_user = site_url("/auth/owner_profile?owner_id=".$task['user_id']);
                                             ?>
                                                <?php echo $owner_show_name;?>
                                             
                                             <?php echo ", ".$view_labels['task_in']?>:
                                             <br>
                                    ...
                                    <div style="line-height:1.3em">
                                       ...
                                       <?php   
                                          ...
                                          {
                                             $url_file = site_url($this->config->item("uri_comment_files")."/".$task['id_object']."/".get_filename_uploaded($list_files[$i]['name']));
                                             ?>
                                             <div>
